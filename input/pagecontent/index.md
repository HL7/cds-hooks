...
`detail` | OPTIONAL | *string* | Optional detailed information to display; if provided MUST be represented in [(GitHub Flavored) Markdown](https://github.github.com/gfm/). Note that, unlike FHIR's markdown, GFM permits a [limited subset of HTML](https://github.github.com/gfm/#html-blocks); for unknown client capabilities, services should proceed with caution and give feedback. (For non-urgent cards, the CDS Client MAY hide these details until the user clicks a link like "view more details...").
